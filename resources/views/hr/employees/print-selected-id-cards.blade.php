...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ══════════════════════════════════════════
           WAVE — FRONT
           White bg · inline header (logo + orange name) ·
           orange-ring photo · orange name/position ·
           full-width info table · dual-wave footer QR bottom-right
        ══════════════════════════════════════════ */
        .idc-wave-front {
            background: #ffffff;
            align-items: center;
        ...
        /* White header, logo left + company name right — inline row */
        ...
        .idc-wave-front .wf-photo-ring {
            ...
            border: 0.8mm solid #FFA733; padding: 0.5mm;
        ...
        .idc-wave-front .wf-photo-ring .no-photo {
            ...
            display: flex; align-items: center; justify-content: center;
            color: #E67E00; font-size: 9pt;
        }

        /* Orange name + position */
        .idc-wave-front .wf-name {
            margin-top: 2mm; font-size: 6.5pt; font-weight: 900; color: #E67E00;
            text-transform: uppercase; letter-spacing: 0.5px;
            text-align: center; padding: 0 2mm; line-height: 1.2;
        }
        .idc-wave-front .wf-position {
            margin-top: 0.5mm; font-size: 5pt; font-weight: 700; color: #E67E00;
        ...
        .idc-wave-front .wf-info-label { font-weight: 700; color: #E67E00; text-transform: uppercase; letter-spacing: 0.3px; }
        .idc-wave-front .wf-info-value { font-weight: 600; color: #333; text-align: right; max-width: 55%; }

        /* Dual-wave footer: QR bottom-right, "Authorized" text bottom-left */
        ...
        /* ══════════════════════════════════════════
           WAVE — BACK
           Solid #E67E00 · wave SVGs top+bottom ·
           white text · logo + company + contacts centred
        ══════════════════════════════════════════ */
        .idc-wave-back {
            background: #E67E00;
        ...
        /* ══════════════════════════════════════════
           GOLD — FRONT
           Orange gradient header · white bg body ·
           orange-ring photo · dark name · orange position ·
           id badge pill · solid orange footer QR centred
        ══════════════════════════════════════════ */
        .idc-gold-front { background: #ffffff; align-items: center; }
        .idc-gold-front .front-header {
            width: 100%; background: linear-gradient(135deg, #FFA733, #FFA733);
        ...
        .idc-gold-front .photo-ring {
            width: 18mm; height: 18mm; border-radius: 50%;
            border: 0.8mm solid #F7941D; padding: 0.5mm;
            box-shadow: 0 1mm 3mm rgba(136,99,4,0.35); background: #fff;
        ...
        .idc-gold-front .photo-ring .no-photo {
            ...
            display: flex; align-items: center; justify-content: center; color: #bbb; font-size: 9pt;
        }
        ...
        .idc-gold-front .front-footer {
            margin-top: auto; width: 100%;
            background: linear-gradient(180deg, #F7941D, #F7941D);
        ...
        /* ══════════════════════════════════════════
           GOLD — BACK
           Solid #F7941D gradient · white text ·
           centred logo + company + contacts
        ══════════════════════════════════════════ */
        .idc-gold-back {
                    ...
                    <div class="idc-shell idc-wave-front">
                        ...
                        <div class="wf-wave-footer">
                            <svg class="wave-bg" viewBox="0 0 54 22" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M0,13 C8,5 22,19 36,11 C44,6 50,9 54,7 L54,22 L0,22 Z" fill="#E67E00" opacity="0.6"/>
                            </svg>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="idc-shell idc-wave-back">
                        ...
                        <svg class="back-wave-top" viewBox="0 0 54 14" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0,0 L54,0 L54,9 C38,14 18,4 0,11 Z" fill="#FFA733" opacity="0.5"/>
                        </svg>
