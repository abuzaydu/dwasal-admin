    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" action="{{ url('admin/activated-payments') }}" method="POST">
                    @csrf
                    <div class="col-md-5">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab_1-1" role="tabpanel">
                            <div class="table-responsive">
                                <table id="activated-payments" class="table table-striped display nowrap" style="width: 100%;">
...
@section('page-scripts')
    ...
    <script>
        $(function(){
            ...
            var aptable = $('#activated-payments').DataTable({
                "scrollX": true,
                'bInfo': true,
                buttons: [
                    {
                        extend: 'excel',
                        footer: true,
                        filename: "Activated Payments_" + date,
            ...
            aptable.buttons().container().appendTo('#activated-payments_wrapper .col-md-6:eq(1)');
        });
    </script>
@endsection