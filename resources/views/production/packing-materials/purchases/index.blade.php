    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7 col-sm-12 text-right pt-0">
                <a href="{{route('pm-purchases.create')}}" class="btn btn-primary btn-sm">{{trans('navmenu.purchase_new_pm')}}</a>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                ...
                <div class="card-body">
                   <div class="table-responsive">
                       <table id="del-multiple" class="table table-striped display nowrap" style="width: 100%; font-size: 14px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="showModal('<?php echo $pmpurchase->id; ?>')" data-id="{{$pmpurchase->id}}"><i class="fa fa-money"></i></a> |@endif 
                                        <a href="{{route('pm-purchases.edit', encrypt($pmpurchase->id))}}">
                                            <i class="fa fa-edit" style="color: blue;"></i>
                                        </a> | 
                                        <a href="#" onclick="confirmDelete('<?php echo encrypt($pmpurchase->id); ?>')">
                        ...
                        <form id="frm-example" action="{{url('delete-multiple-pm-purchases')}}" method="POST">
                            @csrf
