              ...
              <div class="toolbar hidden-print">
                <div class="text-end">
                  <div class="btn-group">
                    ...
                    <a href="{{ route('pm-purchases.edit' ,encrypt($purchase->id))}}" class="btn bg-primary" style="margin: 5px;"><i class="fa fa-edit"></i> Update</a>
                  </div>
                </div>
                <hr/>
              </div>
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center">{{$item->basic_uom}}</td>
