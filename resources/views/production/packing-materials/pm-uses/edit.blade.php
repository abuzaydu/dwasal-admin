                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" name="prod_batch" class="form-control form-control-sm mb-1" value="{{$pmuses->prod_batch}}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                   <label class="form-label">{{trans('navmenu.total_cost')}}</label>
                                    <input id="name" type="text" name="total_cost"  class="form-control form-control-sm mb-1" value="{{$pmuses->total_cost}}" readonly="">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="form-label">{{trans('navmenu.date')}}</label>
                                    <input id="date" type="text" placeholder="{{trans('navmenu.pick_date')}}" name="date" class="form-control form-control-sm mb-1" value="{{$pmuses->date}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group float-end">
                                    ...
                                    <a href="javascript:history.back()" class="btn btn-warning btn-sm">{{trans('navmenu.btn_reset')}}</a>
                                </div>
                            </div>
                        </div>
                    </form>
