                            ...
                            <tr>
                                ...
                                <td style="width: 40%">
                                    <table style="width: 100%">
                                        <tbody>
                                            <tr>
                                                <td style="border: none;" class="meta-head">PLC No.</td>
                                                <td style="border: none;"><b>{{ sprintf('%04d', $plc->plc_no)}}</b></td>
                                            </tr>
                                            <tr>
                                                <td style="border: none;" class="meta-head">Date</td>
                                                <td style="border: none;"><b id="date">{{ date('d F, Y H:i:s', strtotime($plc->date)) }}</b></td>
                                            </tr>
                                            <tr>
                                                <td style="border: none;" class="meta-head">Created By</td>
                                                <td style="border: none;"><b class="date">{{ $plc->first_name }} {{ $plc->last_name }}</b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                        ...
                        <table class="items mt-4" style="width: 100%; border: 1px solid gray;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="desc" style="border-bottom: 1px solid #e0e0e0;">{{$item->stage}}</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border: none; text-align: right;" class="total" ><b>{{number_format($plc->amount_paid, 2, '.', ',')}}</b></td>
                                </tr>
                                <tr>
                                    <td style="border: none;" colspan="2"></td>
                                    <td style="border: none; text-align: right;" class="unit" colspan="2"><b>{{trans('navmenu.unpaid')}} </b> :</td>
                                    <td style="border: none; text-align: right;" class="total" ><b>{{number_format($total-$plc->amount_paid, 2, '.', ',')}}</b></td>
                                </tr>
                                <tr>
                                    <td style="border: none;" colspan="2"></td>
...
@endsection
    ...
    <script language="javascript" type="text/javascript">
        ...
        function savePdf() {
          ...
          var filename = "<?php echo 'Labour Cost_'.'_'.sprintf('%04d', $plc->plc_no); ?>";
          var opt = {
              margin:       0.5,
