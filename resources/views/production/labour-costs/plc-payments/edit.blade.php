        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content py-3">
                    <form class="row g-1 form" method="POST" action="{{route('plc-payments.update', encrypt($plcpay->id))}}">
                        @csrf
                        {{ method_field('PATCH') }}
                        <div class="col-md-3">
                            ...
                            <div class="inner-addon left-addon">
                                ...
                                <input type="text" name="pay_date" id="pay_date" placeholder="{{trans('navmenu.pick_date')}}" value="{{$plcpay->pay_date}}" class="form-control form-control-sm mb-3" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">{{trans('navmenu.amount_paid')}} <span  style="color: red; font-weight: bold;">*</span></label>
                            <input id="name" type="number" name="amount" value="{{$plcpay->amount}}" required placeholder="{{trans('navmenu.hnt_amount_paid')}}" class="form-control form-control-sm mb-3">
                        </div>                   
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea class="form-control form-control-sm mb-3" rows="1" name="comments" placeholder="Enter Comments (Optional)....">{{$plcpay->comments}}</textarea>
                        </div>
