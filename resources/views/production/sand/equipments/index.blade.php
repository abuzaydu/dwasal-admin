            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded" id="new-form" style="display: none;">
                        <form class="form row g-3" method="POST" action="{{route('washing-equipments.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="name" type="text" name="equipment_code" required placeholder="Enter equipment Name" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Equipment Name<span style="color: red; font-weight: bold;">*</span></label>
                                <input id="name" type="text" name="equipment_name" required placeholder="Enter equipment Name" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Equipment Type <span style="color: red; font-weight: bold;">*</span></label>
                                <input id="location" type="text" name="equipment_type" required placeholder="Enter equipment type" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Manufacturer <span style="color: red; font-weight: bold;">*</span></label>
                                <input id="capacity" type="text" name="manufacturer" placeholder="Enter Manufacturer" class="form-control form-control-sm mb-1" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Model <span style="color: red; font-weight: bold;">*</span></label>
                                <input id="capacity" type="text" name="model" placeholder="Enter Model number" class="form-control form-control-sm mb-1" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Installation Date <span style="color: red; font-weight: bold;">*</span></label>
                                <div class="inner-addon left-addon"> 
                                    <i class="myaddon fa fa-calendar"></i>
                                    <input id="op-hours" type="text" name="installation_date" placeholder="Enter Equipment Installation date" class="form-control form-control-sm mb-1" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="inner-addon left-addon"> 
                                    <i class="myaddon fa fa-calendar"></i>
                                    <input type="text" name="next_maintenance_date" id="launch-date" placeholder="Enter Next Maintenance Date" class="form-control form-control-sm mb-1">
                                </div>
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="table-responsive" id="equipment-list">
                        <table id="equipments" class="table table-striped display nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    ...
                                    <th style="text-align: center;">Next Maintenance Date</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">{{$equipment->model}}</td>
                                    <td style="text-align: center;">{{date('d M, Y', strtotime($equipment->installation_date))}}</td>
                                    <td style="text-align: center;">
                                        @if(!is_null($equipment->next_maintenance_date))
                                        {{date('d M, Y', strtotime($equipment->next_maintenance_date))}}
                                        @endif
                                    </td>
                                    <td style="text-align: center;">
                                        <a href="{{route('washing-equipments.edit', encrypt($equipment->id))}}">
                                            <i class="fa fa-edit" style="color: blue;"></i>
                                        </a> | 
                                        <form method="POST" action="{{route('washing-equipments.destroy' , encrypt($equipment->id))}}" id="delete-form-{{$key}}" style="display: inline;"> 
                                            @csrf
                                            @method('DELETE')
