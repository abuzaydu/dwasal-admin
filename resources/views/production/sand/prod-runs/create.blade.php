            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="form row g-3" method="POST" action="{{route('sand-productions.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <label class="form-label">Start DateTime <span style="color: red; font-weight: bold;">*</span></label><div class="inner-addon left-addon"> 
                                    ...
                                    <input type="text" name="start_time" id="start-time" class="form-control form-control-sm mb-1" placeholder="Enter Production Start Time" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="inner-addon left-addon"> 
                                    <i class="myaddon fa fa-calendar"></i>
                                    <input type="text" name="end_time" id="end-time" class="form-control form-control-sm mb-1" placeholder="Enter Production Start Time" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Input Quantity <span style="color: red; font-weight: bold;">*</span></label>
                                <input id="input-qty" type="number" min="0" step="any" name="input_quantity" placeholder="Enter Raw Material Input Qty" class="form-control form-control-sm mb-1" required>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Output Quantity </label>
                                <input id="output-qty" type="number" min="0" step="any" name="output_quantity" placeholder="Enter Output Produced Qty" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Waste Water Quantity </label>
                                <input id="waste-qty" type="number" min="0" step="any" name="waste_water_quantity" placeholder="Enter Waste Water Qty" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-9">
                                <label class="form-label">Remarks </label>
                                <input type="text" name="remarks" class="form-control form-control-sm mb-1" placeholder="Enter Production Remarks">
                            </div>
                            <div class="col-md-6">
