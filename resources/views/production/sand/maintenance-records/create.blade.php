        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h6 class="mb-0"><i class="fa fa-plus me-1"></i> {{ $page }}</h6>
                </div>

                <form method="POST" action="{{ route('maintenance-records.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-4">
                                ...
                                <select name="washing_equipment_id" class="form-select form-select-sm py-1" required>
                                    ...
                                    @foreach($equipments as $eq)
                                        <option value="{{ $eq->id }}">{{ $eq->equipment_name }}{{ $eq->equipment_type ? ' - '.$eq->equipment_type : '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="maintenance_type" class="form-control form-control-sm py-1" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label small mb-1">Technician</label>
                                <input type="text" name="technician" class="form-control form-control-sm py-1">
                            </div>

                            <div class="col-md-12">
                                <label class="form-label small mb-1">Description of WO</label>
                                <textarea name="description_of_wo" rows="2" class="form-control form-control-sm py-1"></textarea>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label small mb-1">Inspection Findings</label>
                                <textarea name="inspection_findings" rows="2" class="form-control form-control-sm py-1"></textarea>
                            </div>

                            <div class="col-md-12">
                                <label class="form-label small mb-1">Parts Used</label>
                                <textarea name="parts_used" rows="2" class="form-control form-control-sm py-1"></textarea>
                            </div>

                            <div class="col-md-3">
                                <label class="form-label small mb-1">Cost</label>
                                <input type="number" name="cost" step="0.01" min="0" class="form-control form-control-sm py-1" value="0">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="notes" class="form-control form-control-sm py-1">
                            </div>

                            <div class="col-md-12">
                                <label class="form-label small mb-1">Photos (multiple)</label>
