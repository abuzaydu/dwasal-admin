...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form class="dashform" action="{{ url('rm-supplier-account-stmt/'.encrypt($supplier->id))}}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="tab-content pt-3">
                            <div class="tab-pane active" id="tab_1-0">
                                ...
                                <a href="#" onclick="javascript:savePdf()" class="btn bg-warning btn-sm" style="margin: 5px;"><i class="fa fa-download"></i> Download PDF</a>
                                <a href="#" onclick="javascript:printDiv('inv-content')" class="btn btn-info btn-sm" style="margin: 5px;"><i class="fa fa-printer"></i> Print</a>
                            </div>
                                        ...
                                        <table id="example1" class="table table-striped display nowrap" style="width: 100%;">
                                            ...
                                            @foreach($payments as $index => $trans)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">{{number_format($trans->payment)}}</td>
                                                    <td style="text-align: center;">
                                                        <a href="{{url('rm-purchase-payments/show-voucher' , encrypt($trans->pv_no))}}"><i class="fa fa-eye"></i> {{trans('navmenu.show_voucher')}}</a> | 
