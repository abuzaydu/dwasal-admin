            ...
            <div class="card radius-6">
                <div class="card-header pb-0 border-bottom">
                    <h6 class="card-title mb-0">
                        <i class="fa fa-plus me-2 text-success"></i> {{ $page }}
                    </h6>
                </div>

                <form method="POST" action="{{ route('maintenance-types.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body" style="padding: 0.75rem;">
                        <div class="row g-2">
                            <div class="col-md-6">
                                <label class="form-label small mb-1">Type <span class="text-danger">*</span></label>
                                <input type="text" name="type" class="form-control form-control-sm py-1" value="{{ old('type') }}" required>
                            </div>
                            <div class="col-md-3">
