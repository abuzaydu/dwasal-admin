    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                <button type="button" id="new-btn" class="btn btn-primary btn-sm pull-right" data-bs-toggle="modal" data-bs-target="#vehicleModal"><i class="fa fa-plus-square"></i> New Vehicle Requesition.</button>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                        ...
                        <div class="tab-pane fade show active" id="tab_0" role="tabpanel">
                            <div class="table-responsive" id="vehicle-list">
                                <table id="vehicles" class="table table-striped display nowrap" style="width: 100%;">
                                    ...
                                    <tbody>
                                        @foreach($vrequisitions as $key => $vehicle)
                                        <tr>
                                            <td>{{$key+1}}</td>
