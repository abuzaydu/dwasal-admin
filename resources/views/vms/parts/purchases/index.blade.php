                ...
                <div class="card-body">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#purchases" role="tab" aria-selected="false">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="tab-title">Purchases List</div>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ url('vendors') }}" role="tab" aria-selected="false">
                                        <div class="d-flex align-items-center">
                                            <div class="tab-icon"><i class='fa fa-outline font-18 me-1'></i>
                                            </div>
                                            <div class="tab-title">Vendors</div>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ route('part-purchases.create') }}">
                                        <div class="d-flex align-items-center">
                                            <div class="tab-icon"><i class='fa fa-plus-circle font-18 me-1'></i>
                                            </div>
                                            <div class="tab-title">New Purchase</div>
                                        </div>
                                    </a>
                                </li>
                    ...
                    <div class="tab-content py-3">
                        <div class="tab-pane fade show active table-responsive" id="purchases" role="tabpanel">
                            <table id="del-multiple" class="table table-striped table-bordered display nowrap" style="width:100%; font-size: 14px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$purchase->user}}</td>
                                        <td>
                                            <a href="{{route('purchases.edit' , encrypt($purchase->id))}}"><i class="fa fa-edit" style="color: blue;"></i></a> |
                            ...
                            <form id="frm-example" action="{{url('delete-multiple-part-purchases')}}" method="POST">
                                @csrf
