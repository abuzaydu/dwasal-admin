            ...
            <div class=" card radius-6">
                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="needs-validation row mb-1" id="stockform" method="POST" action="{{route('parts-usage.update', encrypt($pusage->id))}}">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="vehicle_id" id="vehicle_id" required class="form-select form-select-sm mb-1">
                                    ...
                                    @if($pusage->vehicle_id == $vehicle->id)
                                    <option value="{{$vehicle->id}}" selected>{{$vehicle->plate_no}} {{$vehicle->vehicle_name}}</option>
                                    @else
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control form-control-sm mb-1" name="remarks" id="remarks" value="{{$pusage->remarks}}">
                            </div>
                        </form>
                        <div class="row mb-1">
