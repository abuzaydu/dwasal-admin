                    ...
                    <form method="POST" action="{{ route('vms-expenses.store') }}">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="employee_id" class="form-select form-select-sm select2" required>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="vendor_id" class="form-select form-select-sm select2" required>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="vehicle_id" class="form-select form-select-sm select2" required>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select name="trip_type_id" class="form-select form-select-sm select2" required>
