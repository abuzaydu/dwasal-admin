            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="row g-1" method="POST" action="{{ route('ownerships.update', encrypt($ownership->id)) }}">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="col-md-5 pt-2">
                                <label class="form-label">Ownership Type <span style="color: red;">*</span></label>
                                <input id="register-username" type="text" name="type" value="{{$ownership->type}}" required placeholder="Enter Ownership type" class="form-control form-control-sm mb-1">
                            </div>
                            <div class="col-md-7">
                                <label class="form-label">Description?</label>
                                <input type="text" name="description" value="{{$ownership->description}}" class="form-control form-control-sm mb-1" placeholder="Enter Description">
                            </div>
                            <div class="col-md-12">
