...
<body class="theme-orange">
                        ...
                        <ul class="nav navbar-nav">  
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu user-menu menu-icon animated bounceIn">
                                    ...
                                    <li><a href="{{ url('settings') }}"><i class="icon-user"></i> <span>Branch/Shop Settings</span></a></li>
                    ...
                    <div class="navbar-collapse align-items-center collapse" id="navbar">
                        <ul class="navbar-nav">
                            <li class="nav-item {{ request()->is('settings') ? 'active' : '' }}">
                                <a href="{{ url('settings') }}" class="nav-link"><i class="fa fa-cogs"></i> <span>General Settings</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('user-profile') ? 'active' : ''}}">
                                <a href="{{ url('user-profile') }}" class="nav-link"><i class="icon-user"></i> <span>My Profile</span></a>
                            </li>  
                            <li class="nav-item {{ request()->is('user-companies') ? 'active' : '' }}">
                                <a href="{{ url('user-companies') }}" class="nav-link"><i class="icon-list"></i> <span> Companies</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('shops') ? 'active' : ''}}">
                                <a href="{{ url('shops') }}" class="nav-link"><i class="fa fa-list-alt"></i> <span>Branches</span></a>
                            </li>  
                            <li class="nav-item {{ request()->is('users') ? 'active' : ''}}">
                                <a href="{{ url('users-and-roles') }}" class="nav-link"><i class="icon-users"></i><span>Users & Roles</span></a>
                            </li> 
                            <li class="nav-item dropdown {{ request()->is('delivery-rates') || request()->is('unit-equivalents') ? 'active' : '' }}">
                                <a href="{{ url('delivery-rates') }}" href="javascript:void(0)" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-money"></i> <span> Delivery Settings</span></a>
                                <ul class="dropdown-menu animated bounceIn">
                                    <li><a href="{{ url('delivery-rates') }}"> <span>Delivery Rates</span></a></li>
                                    <li><a href="{{ url('unit-equivalents') }}"> <span>Unit Equivalents</span></a></li>
                                </ul>
                            </li>
                            <li class="nav-item {{ request()->is('recyclebin') ? 'active' : '' }}">
                                <a href="{{ url('recyclebin') }}" class="nav-link"><i class="icon-trash"></i> <span> Recyclebin</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
   ...
   <?php
        ...
        if ($page == 'Home' || $page == 'Quote Requests') {
