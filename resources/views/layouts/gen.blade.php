                    ...
                    <div class="tab-pane fade show active" id="hr_menu" role="tabpanel">
                        <nav class="sidebar-nav">
                            <ul class="metismenu list-unstyled">
                                ...
                                <li class="{{ request()->is('dreport-summary') || request()->is('reports') || request()->is('total-report') || request()->is('consolidated') || request()->is('discount-by-sales') || request()->is('reports') || request()->is('company-income-stmt') || request()->is('company-cash-flow-stmt') || request()->is('balance-sheet') || request()->is('general-ladger') ? 'mm-active active' : '' }}"><a class="has-arrow" href="{{ url('reports') }}"><i class="fa fa-line-chart"></i><span> Reporting</span></a></li>
                                @endif
                                <hr>
                                <li style="padding-left: 15px;" class="text-uppercase mb-3">Account & Settings</li>
                                @if(Auth::user()->can('edit-settings'))
                                <li class="{{ request()->is('settings') ? 'active' : '' }}">
                                    <a href="{{ url('settings') }}">
                                        <i class="fa fa-cogs"></i>
                                        <span>{{ trans('navmenu.settings') }}</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('user-profile') ? 'active' : '' }}">
                                    <a href="{{ url('user-profile') }}">
                                        <i class="fa fa-user"></i>
                                        <span>{{ trans('navmenu.my_account') }}</span>
                                    </a>
                                </li>
                                <!-- <li class="{{ request()->is('verify-payment') ? 'active' : '' }}">
                                    <a href="{{ url('verify-payment') }}">
                                        <i class="fa fa-money"></i>
                                        <span>{{ trans('navmenu.payments') }}</span>
                                    </a>
                                </li> -->
                                @endif

                                @if(Auth::user()->can('manage-sms-templates') || Auth::user()->can('send-sms'))
                                <li class="{{ request()->is('sms-notifications') ? 'active' : '' }}">
                                    <a href="{{ url('sms-notifications') }}">
                                        <i class="fa fa-comment-o"></i>
                                        <span>SMS Notify & Templates</span>
                                    </a>
                                </li>
                                @endif
                                @if(Auth::user()->can('view-recyclebin'))
                                <li class="{{ request()->is('recyclebin') ? 'active' : '' }}">
                                    <a href="{{ url('recyclebin') }}">
                                        <i class="fa fa-trash"></i>
                                        <span>{{ trans('navmenu.recyclebin') }}</span>
                                    </a>
                                </li>
                                @endif
                                @if(Auth::user()->can('view-action-logs'))
                                <li class="{{ request()->is('action-logs') ? 'active' : '' }}">
