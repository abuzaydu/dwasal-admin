                    ...
                    <div class="d-flex mb-3 pb-3 border-bottom align-items-center">
                        ...
                        <div class="dropdown flex-grow-1">
                            ...
                            <ul class="dropdown-menu p-2 shadow-sm">
                                <li><a href="{{ url('user-profile') }}"><i class="fa fa-user me-2"></i>My Account</a></li>
                                <li class="divider"></li>
                    ...
                    <div class="tab-pane fade show active" id="hr_menu" role="tabpanel">
                        <nav class="sidebar-nav">
                            <ul class="metismenu list-unstyled">
                                ...
                                <li class="{{ request()->is('mhc-dashboard') ? 'active' : '' }}">
                                    <a href="{{ url('mhc-dashboard') }}">
                                ...
                                <li class="{{ request()->is('medical-histories') ? 'active' : '' }}">
                                    <a href="{{ url('medical-histories') }}">
                                        <i class="fa fa-list-alt"></i>
