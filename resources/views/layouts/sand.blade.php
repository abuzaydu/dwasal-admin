...
<body class="theme-orange">
   ...
   <?php
        ...
        if ($page == 'Home' || $page == 'Raw Material Sourcings' || $page == 'Production Runs' || $page == 'Quality Tests' || $page == 'Washing Plants' || $page == 'Washing Equipments' || $page == 'Storage Locations' || $page == 'Raw Material Sources' || $page == 'Production Dashboard') {
