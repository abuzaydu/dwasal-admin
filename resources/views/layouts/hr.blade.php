                    ...
                    <div class="tab-pane fade show active" id="hr_menu" role="tabpanel">
                        <nav class="sidebar-nav">
                            <ul class="metismenu list-unstyled">
                                ...
                                <li class="{{ request()->is('positions') || request()->is('employees') || request()->is('employees/create') || request()->is('employees/face-id') || request()->is('employees/fingerprint') ? 'mm-active active' : '' }}">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        @endcan
                                        <li><a href="{{ url('employees') }}" class="{{ request()->is('employees') && !request()->is('employees/face-id') && !request()->is('employees/fingerprint') ? 'active' : '' }}">All Employees</a></li>
                                        ...
                                        <li><a href="{{ route('employees.fingerprint.index') }}" class="{{ request()->is('employees/fingerprint') ? 'active' : '' }}"><i class="fa fa-fingerprint"></i> Fingerprint</a></li>
