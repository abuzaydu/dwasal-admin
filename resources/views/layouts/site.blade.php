            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    <div class="navbar-collapse align-items-center collapse" id="navbar">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown {{ request()->is('carousels') || request()->is('faqs') ? 'active' : '' }}">
                                <a href="javascript:void(0)" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="icon-list"></i> Website Settings<span></span></a>
                                <ul class="dropdown-menu animated bounceIn">
                                    <li><a href="{{ url('carousels') }}"><i class="icon-picture"></i> <span>Carousels</span></a></li>
                                    <li><a href="{{ url('abouts') }}"><i class="icon-info"></i> <span>Abouts</span></a></li>
                                    <li><a href="{{ url('general-services') }}"><i class="icon-magnifier"></i> <span>General Services</span></a></li>
                                    <li><a href="{{ url('faqs') }}"><i class="icon-question"></i> <span>Faqs</span></a></li>
                                    <li><a href="{{ url('teams') }}"><i class="icon-users"></i> <span>Teams</span></a></li>
                                    <li><a href="{{ url('testimonials') }}"><i class="icon-doc"></i> <span>Testimonials</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
