            ...
            <div class="card-body row">
                ...
                <div class="col-md-4 d-flex justify-content-end">
                    <form action="{{ url('empty-recycle-expenses') }}" method="POST" id="empty-recycle-sales">
                        @csrf
                        <button type="submit" class="btn btn-outline-danger " id="submitdr"> <i class="fa fa-trash"></i> Empty Expenses's Recyclebin</button>
                    </form>
                </div>
                            ...
                            <table id="empty-multiple" class="table table-striped display nowrap" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="button" onclick="confirmRecycleExpense('<?php echo encrypt($expense->id); ?>')"> <i class="fa fa-recycle"></i> Restore</a> | 
                                            <a href="#" class="button" onclick="confirmDeleteExpense('<?php echo encrypt($expense->id); ?>')"><i class="fa fa-trash" style="color: red;"></i> Delete Parmanently</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                            <form id="del-expenses" action="{{ url('del-multiple-recycle-expenses') }}" method="POST">
                                @csrf
                                <button id="submitDelButton" class="btn btn-danger" name="dele" value="delete1">{{ trans('navmenu.delete_selected') }}</button>
                                <button id="submitResButton" type="submit" name="action" value="restore" class="btn btn-primary">{{ trans('navmenu.restore_selected') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
...
@section('page-scripts')
    ...
    <script type="text/javascript">
        ...
        $('#del-expenses').on('submit', function(e){
            var form = this;
