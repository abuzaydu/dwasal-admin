                            ...
                            <tbody>
                                ...
                                <tr>    
                                    ...
                                    <td class="qty" style="text-align: center;">
                                        <input class="edit" type="number" min="0" id="qty_{{$item->id}}" value="{{$item->req_qty+0}}" style="text-align: center;">
                                    </td>
                                    <td class="destin" style="text-align: center;">{{$item->quantity+0}}</td>
                                    <td style="text-align: center;">
                                        <a href="{{ url('remove-item/'.encrypt($item->id)) }}" class="text-danger" title="Remove Item"><i class="fa fa-x-circle"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
