                ...
                <div class="card-body">
                    <div id="invoice-view">
                        <div class="row g-1 print_invoice" id="print-st">
                            ...
                            <div class="col-md-12" style="margin-top: 15px; font-size: 12px;">
                                <div class="issuer" style="width: 50%; float: left; padding-left: 55px;">
                                    <table>
                                        <tr>
                                            <td>
                                                <span style="text-transform: uppercase;">{{trans('navmenu.transfer_by')}}</span><br>
                                                {{trans('navmenu.name')}} : <strong>@if(!is_null($user)){{$user->first_name}} {{$user->last_name}}@endif</strong><br>
                                                Date <strong>@if(!is_null($transorder->confirm_time)){{date('d M Y H:i A', strtotime($transorder->confirm_time))}}@endif</strong>
                                            </td>
                                        </tr>
                                    </table>                
                                </div>
                                <div class="receiver" style="width: 50%; float: right; padding-left: 55px;">
                                    <table>
                                        <tr>
                                            <td>
                                                <span style="text-transform: uppercase;">{{trans('navmenu.stock_received_by')}}</span><br>
                                                {{trans('navmenu.name')}} : <strong>@if(!is_null($requester)){{$requester->first_name}} {{$requester->last_name}}@endif</strong><br>
                                                Date <strong>@if(!is_null($transorder->receive_time)){{date('d M Y H:i A', strtotime($transorder->receive_time))}}@endif</strong>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
