            ...
            <div class=" card radius-6">
                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="row g-3 needs-validation" name="orderform" method="POST" action="{{ url('transfer-item-to-item') }}">
                            @csrf
                            <div class="col-sm-4">
                                <label for="shop_id" class="form-label">Source Product <span style="color: red; font-weight: bold;">*</span></label>
                                <select name="source_product_id" class="form-select form-select-sm mb-1 select2" required>
                            ...
                            <div class="col-sm-4">
                                <label for="shop_id" class="form-label">Source Packaging </label>
                                <select name="source_pm_id" class="form-select form-select-sm mb-1">
                                    <option value="">--Select--</option>
                                    @foreach($pmaterials as $pm)
                            ...
                            @endif
                            <div class="col-sm-4">
                                <label for="shop_id" class="form-label">End Product <span style="color: red; font-weight: bold;">*</span></label>
                                <select name="destin_product_id" class="form-select form-select-sm mb-1 select2" required>
                                    <option value="">--Select--</option>
                                    @foreach($products as $product)
                                    <option value="{{$product->id}}">{{$product->name}}</option>
                                    @endforeach
                            ...
                            <div class="col-sm-4">
                                <label for="date_set" class="form-label">Quantity <span style="color: red; font-weight: bold;">*</span></label>
                                <input type="text" name="quantity_in" class="form-control form-control-sm mb-1" placeholder="Enter End Product Quantity"  aria-describedby="calendar" required>
                            </div>
                            @IF($shop->business_type_id == 1)
                            <div class="col-sm-4">
                                <label for="shop_id" class="form-label">End Product Packaging </label>
                                <select name="destin_pm_id" class="form-select form-select-sm mb-1">
                                    <option value="">--Select--</option>
                                    @foreach($pmaterials as $pm)
                                    <option value="{{$pm->id}}">{{$pm->name}}</option>
                                    @endforeach
