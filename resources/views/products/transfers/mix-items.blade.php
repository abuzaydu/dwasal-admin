            ...
            <div class=" card radius-6">
                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="row g-3 needs-validation" id="orderform" method="POST" action="{{ url('transfer-mix-items') }}">
                            @csrf
                            <div class="col-md-12">
                                <div class="row g-1">
                                    <div class="col-md-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="del" style="text-align: center;">
                                                            <a href="{{ url('remove-mix-item/'.encrypt($item->id))}}"><i class="fa fa-close" style="color: red;"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                            <input type="hidden" name="" id="sel-items" value="{{$temps->count()}}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="row g-1">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="input-group mb-0">
                                                    <input type="text" class="form-control form-control-sm mb-1" id="search_end_key" placeholder="{{trans('navmenu.search_product')}}" autocomplete="off" aria-label="Recipient's username" aria-describedby="button-addon2">
                                                </div>
                                                <ul id="searchResult" class="list-group"></ul>

                                                <input type="hidden" name="product_id" id="end-product">
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label">Quantity <span style="color: red;">*</span></label>
                                                <input type="number" name="quantity_in" class="form-control form-control-sm mb-1" placeholder="Enter Produced Quantity" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
