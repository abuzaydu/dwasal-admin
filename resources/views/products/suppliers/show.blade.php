    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-right">
                <form class="dashform row g-3"  action="{{ url('supplier-account-stmt/'.encrypt($supplier->id))}}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 pt-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{$supplier->contact_no}}" class="form-control form-control-sm mb-1" readonly>
                            </div>
                        </div>
