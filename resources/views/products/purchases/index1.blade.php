    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                <form class="dashform row g-1" action="{{ url('f-productions') }}" method="POST" id="stockform">
                    @csrf
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#purchases" role="tab" aria-selected="false">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="tab-title"> Productions</div>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" href="{{ url('productions/create-production') }}">
                                        <div class="d-flex align-items-center">
                                            <div class="tab-icon"><i class='fa fa-plus-circle font-18 me-1'></i>
                                            </div>
                                            <div class="tab-title"> New Production</div>
                                        </div>
                                    </a>
                                </li>
                            </ul>
