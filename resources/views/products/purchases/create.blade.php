            ...
            <div class=" card radius-6">
                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form class="needs-validation" id="stockform" method="POST" action="{{route('purchases.store')}}" ng-if="purchasetemp">
                            @csrf
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-2">
                                    <div id="order_no">
                                        ...
                                        <input type="text" class="form-control form-control-sm mb-3" id="ord_no" placeholder="{{trans('navmenu.hnt_order_no')}}" name="order_no" value="{{$purchasetemp->order_no}}" readonly/>
                                    </div> 
                                </div>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-responsive table-striped display nowrap" style="width: 100%; display: block; overflow: scroll; overflow: auto;">
                                        ...
                                        <tr>
                                            ...
                                            @if(Auth::user()->can('view-purchase-cost'))
                                            <th></th>
                                            <th style="text-align: center;"><b>@{{sum(stocktempitems) | number:2}} (@{{purchasetemp.currency}})</b></th>
                                            @endif
                                            <th></th>
                                            @if($settings->enable_exp_date)
                                            <th></th>
                            ...
                            <div class="row mb-1">
                                <input type="hidden" name="" id="no_items" value="@{{selecteditems(stocktempitems)}}">
                                <div class="col-sm-6">
