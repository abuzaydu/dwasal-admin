    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-right pt-0">
                <form class="dashform row g-3" action="{{url('total-purchase-payments')}}" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 invoice-content" style="border-top: 2px solid #82B1FF;">
                                <table class="table mt-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray;" colspan="5">Cash Purchases Payments</th>
                                            <th style="text-align: center; border-bottom: 1px solid gray;" colspan="5">Credit Purchases Payments</th>
                                        </tr>
                                        <tr>
