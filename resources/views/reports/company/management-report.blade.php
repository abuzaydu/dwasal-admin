    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('f-management-report') }}" method="POST">
                    @csrf
                    <div class="col-md-4">
                                    ...
                                    <div class="col-xs-12 invoice-content" style="overflow-x: auto;">
                                        <table class="table mt-0" style="width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th style="border-bottom: 1px solid gray; border-right: 1px solid gray;">Total Income</th>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th style="border-bottom: 1px solid gray; border-right: 1px solid gray;">Total Cost of Sale</th>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th style="border-bottom: 1px solid gray; border-right: 1px solid gray;">Total Margin</th>
                                                ...
                                                @endforeach
                                                <tr>
                                                    <th style="border-bottom: 1px solid gray; border-right: 1px solid gray;">Total Expenses/Overheads</th>
                                                ...
                                                <tr>
                                                    <th style="border-bottom: 1px solid gray; border-right: 1px solid gray;">Net Income</th>
