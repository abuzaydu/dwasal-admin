    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('daily-deposit-report') }}" method="POST">
                    @csrf
                    <div class="col-md-2">
                                    ...
                                    <div class="col-xs-12 invoice-content" style="overflow-x: auto;">
                                        <table id="table" class="mt-0" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th colspan="5"></th>
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #d7dbdd;">Total</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #fedad2;">Pending Days To Date</th>
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Amount Paid To Date</th>
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #fedad2;">Amount Pending To Date</th>
                                                    <th style="text-align: right; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Comments</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; white-space: nowrap;">{{$dep['driver']}}</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; white-space: nowrap;">{{$dep['start_date']}}</td>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #fedad2;">@if($dep['pending_to_date'] > 0){{$dep['pending_to_date']}}@else 0 @endif</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{number_format($dep['paid_days']*$dep['depperday'])}}</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #fedad2;">@if($dep['pending_to_date'] > 0){{number_format($dep['pending_to_date']*$dep['depperday'])}}@else 0 @endif</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; white-space: nowrap;">@if($dep['pending_to_date'] > 0)
                                                        Under Deposits
                                                    @elseif($dep['pending_to_date'] == 0)
                                                        OK
                                                    @else
                                                        OverDeposits
                                                    @endif</td>
