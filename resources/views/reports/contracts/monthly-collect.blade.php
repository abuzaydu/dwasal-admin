    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('monthly-collection-report') }}" method="POST">
                    @csrf
                    <div class="col-md-2">
                        <input type="text" id="rider" class="form-control form-control-sm mb-1" placeholder="Search Rider" />
                    </div>
                    <div class="col-md-2">
                            ...
                            <div id="inv-content" class="print_invoice p-0" style="border: 1px solid gray;">
                                <div class="row g-1">
                                    ...
                                    <div class="col-xs-12 invoice-content" style="overflow-x: auto;">
                                        <table id="table" class="items mt-0" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <td colspan="7" style="text-align: center; border-left: 1px solid gray; border-bottom: 0px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;"></td>
                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Expected</th>

                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; border-top: 2px solid #82B1FF;"><b>{{number_format($totalexp, 2,'.',',')}}</b></td>
                                                    <td colspan="2" style="text-align: center; border-left: 1px solid gray; border-bottom: 0px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 0px solid gray; vertical-align: middle;"><b></b></td>

                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #9ffce1;">Balance C/F</th>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color:  #9ffce1;"><b>{{number_format($totalprepaid, 2,'.',',')}}</b></td>

                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color:  #9ffce1;"><b>@if($totalexp > 0){{number_format(($totalprepaid/$totalexp)*100)}}@else 0 @endif%</b></td>

                                                </tr>
                                                <tr>

                                                    <td colspan="7" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 0px solid gray; vertical-align: middle; text-transform: uppercase; text-align: center;"><b>Performance</b></td>
                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #ebfbb7;">Amount Paid</th>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #ebfbb7;"><b>{{number_format($totalpaid, 2,'.',',')}}</b></td>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #ebfbb7;"><b>@if($totalexp > 0){{number_format(($totalpaid/$totalexp)*100)}}@else 0 @endif%</b></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 0px solid gray; vertical-align: middle;"><b></b></td>

                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #f7f646;">Over Paid</th>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #f7f646;"><b>{{number_format(($totaldeposited-$totalpaid), 2,'.',',')}}</b></td>
                                                </tr>
                                                 <tr>
                                                    <td colspan="7" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 0px solid gray; vertical-align: middle; text-transform: uppercase; text-align: center;"><b></b></td>

                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #39f603;">Deposited</th>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #39f603;"><b>{{number_format($totaldeposited, 2,'.',',')}}</b></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 0px solid gray; vertical-align: middle; text-transform: uppercase; text-align: right;"><b></b></td>

                                                    <th colspan="2" style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #fae1de;">Pending Amount</th>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #fae1de;"><b>{{number_format(($totalexp-$totalpaid-$totalprepaid), 2,'.',',')}}</b></td>
                                                    <td colspan="2" style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #fae1de;"><b>@if($totalexp > 0){{number_format((($totalexp-$totalprepaid-$totalpaid)/$totalexp)*100)}}@else 0 @endif%</b></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #9ffce1;">Balance C/F</th>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #39f603;">Deposited</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle;">{{$dep['driver']}}</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{$dep['start_date']}}</td>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #9ffce1;">{{number_format($dep['pre_paid_amt'], 2,'.',',')}}</td>
