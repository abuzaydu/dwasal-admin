    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('tl-monthly-performance-report') }}" method="POST">
                    @csrf
                    <div class="col-md-2">
                                    ...
                                    <div class="col-xs-12 invoice-content" style="overflow-x: auto;">
                                        <table class="items mt-0" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <td></td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; border-top: 2px solid #82B1FF;"><b>{{trans('navmenu.total')}}</b></td>
                                                    <th style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; border-top: 2px solid #82B1FF;"><b>{{number_format($texpectedamt, 2,'.',',')}}</b></th>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #ebfbb7; border-top: 2px solid #82B1FF;"><b>{{number_format($tpaidamt, 2,'.',',')}}</b></td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; background-color: #fae1de; border-top: 2px solid #82B1FF;"><b>{{number_format($tpendingamt, 2,'.',',')}}</b></td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center; border-top: 2px solid #82B1FF;"><b>{{$tperformance}}%</b></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #ebfbb7;">Collected Amount</th>
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF; background-color: #fae1de;">Pending Amount</th>
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Performance (%)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{number_format($dep['expected_amt'], 2,'.',',')}}</td>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{number_format($dep['pending_amt'], 2,'.',',')}}</td>
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{ $dep['performance'] }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
