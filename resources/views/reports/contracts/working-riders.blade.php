    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('working-riders-report') }}" method="POST" id="stockform">
                    @csrf
                    <div class="col-md-3">
                                        ...
                                        <table id="table" class="mt-0" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Days Worked</th>
                                            ...
                                            <tbody>
                                                @foreach($workingriders as $index =>  $expgrad)
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{ $expgrad['days_worked'] }}</td>
