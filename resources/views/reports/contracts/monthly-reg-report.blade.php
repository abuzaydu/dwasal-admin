    ...
    <div class="block-header pt-4">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 text-right pt-0">
                <form class="dashform row g-1" id="filter-form" action="{{ url('monthly-reg-report') }}" method="POST">
                    @csrf
                    <div class="col-md-2">
                                        ...
                                        <table class="table mt-0" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; border-bottom: 1px solid gray; border-right: 1px solid gray; border-top: 2px solid #82B1FF;">Days Left</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($contracts as $index =>  $contract)
                                                <?php $diff = strtotime($contract->end_date)-strtotime($today);
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid gray; border-left: 1px solid gray; border-bottom: 1px solid gray; vertical-align: middle; text-align: center;">{{$days_left }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
