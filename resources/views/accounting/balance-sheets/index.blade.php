        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 text-right">
                <form class="row g-1" method="POST" action="{{ url('f-balance-sheets') }}">
                    ...
                    <div class="col-md-9">
                        @if($mbs == 0)
                        <a href="{{ route('balance-sheets.create') }}" class="btn btn-primary btn-sm">Generate Balance Sheet for Last Month</a>
                        @endif
                        <a href="{{ url('basic-balance-sheets') }}" class="btn btn-success btn-sm">Basic Balance Sheet Records</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    function confirmUpdates() {
        Swal.fire({
            ...
            if (result.value) {
                window.location.href="{{ url('monthly-balance-sheet') }}";
            }
        })
    }
    ...
    $(document).ready(function(){
        ...
        $(".edit").focusout(function(){
            ...
            $.ajax({
                url: "{{url('update-balance-sheet-item')}}",
                type: 'POST',
