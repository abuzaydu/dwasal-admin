        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('expense-payments') }}"> Expense Payments</a></li>
		                  	...
		                  	<table class="list-items mt-2" style="width: 100%">
			                    ...
			                    <tbody>
                                    ...
                                    @endif
			                      	...
			                      	<tr>
				                        <td style="text-align: left;">Expense Payments</td>
				                        <td class="desc">Payment for {{$pay->expense_type}} of {{date('d M, Y', strtotime($pay->pay_date))}} {{trans('navmenu.paid_on')}} {{date('d.m.Y', strtotime($pay->pay_date))}}</td>
		                  ...
		                  <table style="width: 100%; padding: 10px;">
		                    <tbody>
		                      <tr>
		                        ...
		                        <td style=" width: 20%; padding: 5px; border-bottom: dotted 1px gray;"><b>{{$user->first_name}} {{$user->last_name}}</b></td>
		                        <td style="text-align: right; width: 15%; padding: 5px;">{{trans('navmenu.signature')}} : </td>
		                        <td style=" width: 15%; padding: 5px; border-bottom: dotted 1px gray;"></td>
		                      ...
		                      <tr>
		                        ...
		                        <td style=" width: 25%; padding: 5px; border-bottom: dotted 1px gray;"></td>
		                        <td style="text-align: right; width: 15%; padding: 5px;">{{trans('navmenu.signature')}} : </td>
		                        <td style=" width: 15%; padding: 5px; border-bottom: dotted 1px gray;"></td>
		                        <td style="text-align: right; width: 15%; padding: 5px;">{{trans('navmenu.date')}} : </td>
		                        <td style=" width: 15%; padding: 5px; border-bottom: dotted 1px gray;"></td>
