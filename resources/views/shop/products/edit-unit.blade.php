        ...
        <div class="row">
            <div class="col-lg-6 col-md-8 col-sm-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('products.show', encrypt($prod_unit->product_id))}}">Product Details</a></li>
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{route('product-units.update', encrypt($prod_unit->id))}}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input class="form-control form-control-sm mb-1" type="number" min="0" step="any" name="qty_equal_to_basic" placeholder="Enter quantity" value="{{$prod_unit->qty_equal_to_basic+0}}" required>
                        </div>
                        <div class="col-sm-4">
