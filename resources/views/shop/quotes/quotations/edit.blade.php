    ...
    <div class="row clearfix">
        <div class="col-md-10 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('quotations.update', encrypt($quotation->id)) }}" method="POST"
                        id="quotationForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" name="email" class="form-control"
                                    value="{{ old('email', $quotation->email) }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phone" class="form-control"
                                    value="{{ old('phone', $quotation->phone) }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                    ...
                                    <tr class="item-row" data-product-id="{{ $item->product_id }}">
                                        <td>
                                            ...
                                            <input type="text" name="items[{{ $i }}][description]"
                                                class="form-control form-control-sm" value="{{ $item->item_description }}"
                                                {{ $item->product_id ? 'readonly' : '' }} required>
                                        </td>
                                        ...
                                        <td><button type="button" class="btn btn-sm btn-link text-danger remove-row"
                                                title="Remove"><i class="fa fa-times"></i></button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        <p class="text-muted small" id="noItemsMsg"
                            style="{{ $quotation->items->count() ? 'display:none;' : '' }}">No items added yet. Search and
                            select a product above.</p>

                        <div class="row justify-content-end">
                            <div class="col-md-5">
                                <div class="row mb-2">
                                    <div class="col-6">Subtotal</div>
                                    <div class="col-6 text-end" id="subtotalDisplay">
                                        {{ number_format($quotation->subtotal, 2) }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6">Discount</div>
                                    <div class="col-6"><input type="number" step="0.01" min="0"
                                            name="discount" id="discountInput"
                                            class="form-control form-control-sm text-end"
                                            value="{{ $quotation->discount }}"></div>
                                </div>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6"><input type="number" step="0.01" min="0"
                                            ...
                                            class="form-control form-control-sm text-end"
                                            value="{{ $quotation->tax_amount }}"></div>
                                </div>
                                <div class="row mb-2 fw-bold">
                                    <div class="col-6">Total</div>
                                    <div class="col-6 text-end" id="totalDisplay">
                        ...
                        <div class="text-end">
                            <a href="{{ route('quotations.show', encrypt($quotation->id)) }}"
