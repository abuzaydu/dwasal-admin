...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-xl-12 mx-auto">
            <div class="card">
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{ url('update-invoice-servitem')}}">
                        @csrf
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" step="any" name="repeatition" class="form-control form-control-sm mb-1" value="{{$item->repeatition}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">{{trans('navmenu.price')}}</label>
                                <input type="number" step="any" name="cost_per_unit" class="form-control form-control-sm mb-1" value="{{$item->cost_per_unit}}">
                            </div>
                        </div>
                        <div class="col-md-2">
