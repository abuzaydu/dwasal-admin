            ...
            <div class="card radius-6">
                <div class="card-body" style="overflow: auto;">
                    ...
                    <div class="p-3 border rounded">
                        <form class="row g-1" name="invoiceform" method="POST" action="{{route('pro-invoices.store')}}" onsubmit="return validateform(this)">
                            @csrf
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="input-group mb-0">
                                    ...
                                    <a href="javascript:;" class="btn btn-outline-danger btn-sm mb-1 empty-search"><i class='fa fa-close'></i></a>
                                </div>
                            ...
                            <div class="col-md-12" style="display: block; overflow: auto;">
                                ...
                                <table class="table table-responsive table-striped display nowrap" style="width: 100%; display: block; overflow: scroll; overflow: auto;">
                                    ...
                                    <tr>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th style="text-align: center;">@{{sum(invoicetemp) | number:2}}</th>
                                        @if($settings->discount_by_percent)
                                        <th style="text-align: center;"></th>
                                        @endif
                                        <th style="text-align: center;">@{{sumDiscount(invoicetemp) | number:2}}</th>
                                        @if($settings->is_vat_registered)
                                        <th></th>
                                        <th>@{{sumTax(invoicetemp) | number:2}}</th>
                                        @endif
                                        <th>&nbsp;</th>
                                    </tr>
                                </table>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group mb-0">
                                    ...
                                    <a href="javascript:;" class="btn btn-outline-danger btn-sm mb-1 empty-serv-search" type="submit"><i class='fa fa-close'></i></a>
                                </div>
                                <ul id="searchServiceResult" class="list-group"></ul>
                            </div>
                            <div class="col-md-12" style="display: block; overflow: auto;">
                                <label class="form-label mt-0">Service Items:</label>
                                <table class="table table-responsive table-striped display nowrap" style="width: 100%; display: block; overflow: scroll; overflow: auto;">
                                    <tr>
                                        <th>#</th>
                                        <th>Item name</th>
                                    ...
                                    <tr ng-repeat="newservinvoicetemp in servinvoicetemp">
                                        ...
                                        @endif
                                        <td><a href="#" ng-click="removeServiceSaleTemp(newservinvoicetemp.id)"><span class="fa fa-trash" aria-hidden="true" style="color: red"></span></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <th style="text-align: center;">@{{sumService(servinvoicetemp) | number:2}}</th>
                                        <th style="text-align: center;">@{{sumServiceDiscount(servinvoicetemp) | number:2}}</th>
                                        @if($settings->is_vat_registered)
                                        <th></th>
                                        <th>@{{sumServiceTax(servinvoicetemp) | number:2}}</th>
                                        @endif
                                        <th>&nbsp;</th>
                                    </tr>
                                </table>
                                ...
                                <div class="col-md-6">
                                    <table class="table table-striped" style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td>Subtotal</td>
                                                <td><b>@{{sum(invoicetemp)+sumService(servinvoicetemp) | number:2}}</b></td>
                                            </tr>
                                            <tr>
                                                <td>Discount</td>
                                                <td><b>@{{sumDiscount(invoicetemp)+sumServiceDiscount(servinvoicetemp) | number:2}}</b></td>
                                            </tr>
                                            @if($settings->is_vat_registered) 
                                            <tr>
                                                <td>Tax {{$settings->tax_rate}} %</td>
                                                <td><b>@{{(sumTax(invoicetemp))+(sumServiceTax(servinvoicetemp)) | number:2}}</b></td>
                                            </tr>
                                            @endif
                                            <tr>
                                                <td>Grand Total</td>
                                                <td><b>@{{ ((sum(invoicetemp)-sumDiscount(invoicetemp))+(sumTax(invoicetemp)))+((sumService(servinvoicetemp)-sumServiceDiscount(servinvoicetemp))+(sumServiceTax(servinvoicetemp))) | number:2}}</b></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
