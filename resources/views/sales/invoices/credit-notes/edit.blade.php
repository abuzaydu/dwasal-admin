                ...
                <div class="card-body">
                    <form class="row g-3" method="POST" action="{{route('credit-notes.update', $creditnote->id)}}">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="customer" class="form-control form-control-sm mb-1" value="{{$creditnote->name}}" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Invoice No.</label>
                            <input type="text" name="invoice_no" class="form-control form-control-sm mb-1" value="{{ sprintf('%04d', $creditnote->invoice_no)}}" readonly>
                        </div>
                        <div class="form-group col-md-4">
                            <label>Invoice Date :</label>
                            <input type="text" name="date" class="form-control form-control-sm mb-1" value="{{date('d, M Y', strtotime($creditnote->time_created))}}" readonly>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <a href="javascript:history.back()" class="btn btn-warning btn-sm pull-right">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
