                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td colspan="2" style="text-align: right;">
                                                            ...
                                                            <small>@if(!is_null($shop->postal_address)){{$shop->postal_address}}@endif @if(!is_null($shop->physical_address)){{$shop->physical_address}} <br>@endif @if(!is_null($shop->street)){{$shop->street}},@endif @if(!is_null($shop->district)){{$shop->district}},@endif @if(!is_null($shop->city)){{$shop->city}}@endif @if(!is_null($shop->country)), {{$shop->country}}@endif<br> @if(!is_null($shop->email))Email: <b>{{$shop->email}}</b><br>@endif @if(!is_null($shop->tel))Tel: <b>{{$shop->tel}}</b>@endif @if(!is_null($shop->mobile))Mobile: <b>{{$shop->mobile}}</b><br>@endif @if(!is_null($shop->tin))TIN: <b>{{$shop->tin}}</b>@endif @if(!is_null($shop->vrn))VRN: <b>{{$shop->vrn}}</b>@endif</small>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table style="width: 100%; font-size: 16px;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><b class="date">{{ sprintf('%06d', $sale->invoice_no)}}</b></th>
                                                        </tr>
                                                        <tr>
                                                            <td class="meta-head" style="text-align: right;">Issue Date</td>
                                                            <td><b id="date">{{ date('d M, Y', strtotime($sale->time_created)) }}</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="meta-head" style="text-align: right;">Due Date</td>
                                                            <th><b class="date">{{ date('d M, Y', strtotime($sale->due_date))}}</b></th>
                                                        </tr>
                                                        <tr>
                                                            <td class="meta-head" style="text-align: right;">Branch</td>
                                                            <th><b class="date">{{$shop->name}}</b></th>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                                ...
                                                <td colspan="2" style="width: 100%; padding-left: 5%;">
                                                    ...
                                                    <table style="width: 100%; font-size: 8px;">
                                                        <tbody>
                                                            ...
                                                            @else
                                                            <tr>
                                                                <td><span style="color: orange;">Your bank details not updated. Please update your bank details <a href="{{ url('accounts') }}">Here</a></span>
                                                                </td>
                                                            </tr>
                                                            @endif
                                                        </tbody>
