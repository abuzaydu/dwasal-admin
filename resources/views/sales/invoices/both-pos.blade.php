                    ...
                    <div class="p-3 border rounded print_invoice">
                        ...
                        <form class="form" id="pos-form" name="saleform" method="POST" action="{{ route('pos.store') }}" onsubmit="return validateform(this)" ng-if="saletemp">
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col-sm-12" id="bermsg"></div>
                                @endif
                                @endif
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="input-group mb-0">
                                        ...
                                        <a class="btn btn-outline-danger btn-sm mb-1 empty-serv-search" id="button-addon2"><i class='fa fa-close'></i></a>
                                    </div>
                                    <ul id="searchServiceResult" class="list-group"></ul>
                                </div>
                                <div class="col-sm-12" id="discount_field" style="display: block; overflow: auto;">
                                    ...
                                    <table class="items mt-0" style="width: 100%;">
                                        ...
                                        <tr ng-repeat="newsaletemp in saletempitems" id="temps">
                                            ...
                                            <td style="text-align: center;"><input type="number" style="text-align:center; width: 80px;" autocomplete="off" name="quantity_sold" ng-blur="updateSaleTemp(newsaletemp)" string-to-number ng-model="newsaletemp.quantity_sold" min="0" step="any" value="@{{newsaletemp.quantity_sold}}"></td>
                                            ...
                                            @if($settings->retail_with_wholesale)
                                            <td style="text-align: center;"><select ng-model="newsaletemp.sold_in" name="sold_in" ng-change="updateSaleTemp(newsaletemp)" style="border: 1px solid #e0e0e0;">
                                            ...
                                            @if($settings->enable_cpos)
                                                <input type="number" min="0" step="any" style="text-align:center; width: 80px;" name="retail_price" ng-blur="updateSaleTemp(newsaletemp)" ng-model="newsaletemp.retail_price">
                                            @else
                                            ...
                                            @if(Auth::user()->can('offer-discount'))
                                            @if($settings->discount_by_percent)
                                            <td style="text-align: center;"><input type="number" min="0" step="any" style="text-align:center; width: 80px;" name="disc_percent" ng-blur="updateSaleTemp(newsaletemp)" string-to-number ng-model="newsaletemp.disc_percent"></td>
                                        ...
                                        <tr>
                                            ...
                                            @if($settings->is_vat_registered)
                                            <th></th>
                                            <th style="text-align: center;">@{{sumVAT(saletempitems) | number:2}}</th>
                                            @endif
                                            <th>&nbsp;</th>
                                        </tr>
                                    </table>
                                    <label class="form-label mt-1">Service Items:</label>
                                    <table class="items mt-0" style="width: 100%;">
                                        <tr>
                                            <th>#</th>
                                        ...
                                        <tr ng-repeat="newservsaletemp in servsaletempitems" id="temps">
                                            ...
                                            <td style="text-align: center;"><input type="number" style="text-align:center; width: 80px; border: 1px solid #e0e0e0;" autocomplete="off" name="no_of_repeatition" ng-blur="updateSaleServTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.no_of_repeatition" min="1" step="1" value="@{{newservsaletemp.no_of_repeatition}}" ></td>
                                            <td style="text-align: center;">
                                            @if($settings->enable_cpos)
                                                <input type="number" min="0" step="any" style="text-align:center; width: 80px; border: 1px solid #e0e0e0;" name="price" ng-blur="updateSaleServTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.price">
                                            @else
                                            ...
                                            @if(Auth::user()->can('offer-discount'))
                                            <td style="text-align: center;"><input type="number" min="0" step="any" style="text-align:center; width: 80px; border: 1px solid #e0e0e0;" name="total_discount" ng-blur="updateSaleServTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.total_discount"></td>
                                            @endif
                                            @if($settings->is_vat_registered)
                                            <td style="text-align: center;"><select ng-model="newservsaletemp.with_vat" name="sold_in" ng-change="updateSaleServTemp(newservsaletemp)" style="border: 1px solid #e0e0e0;">
                                                <option value="no">{{trans('navmenu.no')}}</option>
                                                <option value="yes">{{trans('navmenu.yes')}}</option>
                                            </select></td>
                                            ...
                                            <td style="text-align: center;"><a href="#" ng-click="removeSaleServTemp(newservsaletemp.id)"><span class="fa fa-trash" aria-hidden="true" style="color: red"></span></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            ...
                                            @if($settings->is_vat_registered)
                                            <th></th>
                                            <th style="text-align: center;">@{{sumServVAT(servsaletempitems) | number:2}}</th>
                                            @endif
                                            <th>&nbsp;</th>
                                        </tr>
                                    </table>
                                ...
                                <div class="col-md-12" id="discount_value" style="display: none;">
                                    ...
                                    <table class="items mt-0" style="width: 100%;">
                                        ...
                                        <tr ng-repeat="newsaletemp in saletempitems" id="temps">
                                            ...
                                            <td style="text-align: center;">
                                            @if($settings->enable_cpos)
                                                <input type="number" min="0" step="any" style="text-align:center; width: 240px; border: 1px solid #e0e0e0;" name="retail_price" ng-blur="updateSaleTemp(newsaletemp)" string-to-number ng-model="newsaletemp.retail_price">
                                            @else
                                                @{{newsaletemp.retail_price | number:2}}
                                            @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <input type="number" step="any" style="text-align:center; width: 80px; height: 20px;" name="sale_discount" id="prod_discount" value="@{{sumDiscount(saletempitems)}}">
                                            </th>
                                            @if($settings->is_vat_registered)
                                            <th></th>
                                            <th style="text-align: center;">@{{sumVAT(saletemitems) | number:2}}</th>
                                            @endif
                                            <th>&nbsp;</th>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="items mt-0" style="width: 100">
                                        ...
                                        <tr ng-repeat="newservsaletemp in servsaletempitems" id="temps">
                                            ...
                                            <td style="text-align: center;">
                                            @if($settings->enable_cpos)
                                                <input type="number" min="0" step="any" style="text-align:center; width: 100px; border: 1px solid #e0e0e0;" name="price" ng-blur="updateSaleServTemp(newservsaletemp)" string-to-number ng-model="newservsaletemp.price">
                                            @else
                                                @{{newservsaletemp.price | number:2}}
                                            @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            @if(Auth::user()->can('offer-discount'))
                                            <th>
                                                <input type="number" step="any" style="text-align:center; width: 100px;" name="serv_sale_discount" id="serv_discount" value="@{{sumServDiscount(servsaletempitems)}}">
                                            </th>
                                            @endif
                                            @if($settings->is_vat_registered)
                                            <th></th>
                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm mb-3" name="comments" ng-model="saletemp.comments" placeholder="Enter Comments/Note" id="comments"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <table class="items mt-0" style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><b>@{{ (sum(saletempitems)+sumServ(servsaletempitems)) | number:2}}</b></td>
                                        </tr>
                                        @if(Auth::user()->can('offer-discount'))
                                        <tr>
                                            <td><b>{{trans('navmenu.total_discount')}}</b></td>
                                            <td style="text-align: right;"><b>@{{ (sumDiscount(saletempitems)+sumServDiscount(servsaletempitems)) | number:2}}</b></td>
                                        </tr>
                                        @endif
                                        <tr>
                                            <td><b>{{trans('navmenu.vat')}}</b></td>
                                            <td style="text-align: right;"><b>@{{ (sumVAT(saletempitems)+sumServVAT(servsaletempitems)) | number:2}}</b></td>
                                        </tr>
                                        <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#serv_discount').on('blur', function(){
                ...
                angular.element(document.getElementById('mycontroller')).scope().updateServSaleTempDiscount(discount);
            })
        ...
        function addServSaleTemp(element) {
            ...
            angular.element(document.getElementById('mycontroller')).scope().addServSaleTemp(serv_id);
            setTimeout(function(){
                $("#search_serv_key").val('');
                $("#searchServiceResult").empty();
            }, 2000);
