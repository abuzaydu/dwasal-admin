                            ...
                            <div class="col-sm-12">
                                <table class="table table-striped display nowrap" style="width: 100%; display: block; overflow: scroll; overflow: auto;">
                                    ...
                                    <tr ng-repeat="newsaleorder in saleorderitems" id="temps">
                                        ...
                                        <td>
                                            <select ng-model="newsaleorder.product_unit_id" name="product_unit_id" ng-change="updateSaleOrder(newsaleorder)" ng-options="unit.id as unit.unit_name for unit in newsaleorder.units" style="width: 70px;">
