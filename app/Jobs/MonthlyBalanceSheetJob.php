...
class MonthlyBalanceSheetJob implements ShouldQueue
{
    ...
    {
        $shop = $this->shop;
        Log::info('Monthly balance sheet for : '.$shop->name);
        ...
        $mbs = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->count();
        ...
        if ($mbs <= 0) {
            ...
            $mbs_cash = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Cash')->first();
            if (is_null($mbs_cash)) {
                $mbs_cash = new MonthlyBalanceSheet();
            ...
            $mbs_ar = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Accounts Receivable')->first();
            if (is_null($mbs_ar)) {
                $mbs_ar = new MonthlyBalanceSheet();
            ...
            $mbs_inventory = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Inventory')->first();
            if (is_null($mbs_inventory)) {
                $mbs_inventory = new MonthlyBalanceSheet();
            ...
            //Pre-Paid Expenses
            $prepaid_expenses = 0;
            $mbs_prepaid_exp = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Prepaid Expenses')->first();
            if (is_null($mbs_prepaid_exp)) {
                $mbs_prepaid_exp = new MonthlyBalanceSheet();
            ...
            $mbs_sti = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Short-Term Investments')->first();
            if (is_null($mbs_sti)) {
                $mbs_sti = new MonthlyBalanceSheet();
            ...
            $mbs_lti = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Long-Term Investments')->first();
            if (is_null($mbs_lti)) {
                $mbs_lti = new MonthlyBalanceSheet();
            ...
            $mbs_ppe = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Property, Plant, and Equipment')->first();
            if (is_null($mbs_ppe)) {
                $mbs_ppe = new MonthlyBalanceSheet();
            ...
            $mbs_lad = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', '(Less Accumulated Depreciation)')->first();
            if (is_null($mbs_lad)) {
                $mbs_lad = new MonthlyBalanceSheet();
            ...
            $intangible_assets = 0;
            $mbs_ia = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Intangible Assets')->first();
            if (is_null($mbs_ia)) {
                $mbs_ia = new MonthlyBalanceSheet();
            ...
            $mbs_ia = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Deferred Income Tax')->where('item_category', 'OTHER ASSETS')->first();
            if (is_null($mbs_ia)) {
                $mbs_ia = new MonthlyBalanceSheet();
                $mbs_ia->shop_id = $shop->id;
                $mbs_ia->date = $end;
            ...
            $other_assets = 0;
            $mbs_other_assets = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Other')->where('item_category', 'OTHER ASSETS')->first();
            if (is_null($mbs_other_assets)) {
                $mbs_other_assets = new MonthlyBalanceSheet();
            ...
            $mbs_acc_payable = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Accounts Payable')->first();
            if (is_null($mbs_acc_payable)) {
                $mbs_acc_payable = new MonthlyBalanceSheet();
            ...
            $short_term_loans = 0;
            $mbs_st_loan = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Short-Term Loans')->first();
            if (is_null($mbs_st_loan)) {
                $mbs_st_loan = new MonthlyBalanceSheet();
            ...
            $income_tax_payble = 0;
            $mbs_itax_payable = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Income Taxes Payable')->first();
            if (is_null($mbs_itax_payable)) {
                $mbs_itax_payable = new MonthlyBalanceSheet();
            ...
            $mbs_asw = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Accrued Salaries and Wages')->first();
            if (is_null($mbs_asw)) {
                $mbs_asw = new MonthlyBalanceSheet();
            ...
            $unearned_revenue = 0;
            $mbs_uer = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Unearned Revenue')->first();
            if (is_null($mbs_uer)) {
                $mbs_uer = new MonthlyBalanceSheet();
            ...
            $mbs_cp_ltd = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Current Portion of Long-Term Debt')->first();
            if (is_null($mbs_cp_ltd)) {
                $mbs_cp_ltd = new MonthlyBalanceSheet();
            ...
            $long_term_debt = 0;
            $mbs_lt_debt = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Long-Term Debt')->first();
            if (is_null($mbs_lt_debt)) {
                $mbs_lt_debt = new MonthlyBalanceSheet();
            ...
            $mbs_ldi_tax = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Deferred Income Tax')->where('item_category', 'LONG TERM LIABILITIES')->first();
            if (is_null($mbs_ldi_tax)) {
                $mbs_ldi_tax = new MonthlyBalanceSheet();
            ...
            $other_liabilities = 0;
            $mbs_other_liabilities = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Other')->where('item_category', 'LONG TERM LIABILITIES')->first();
            if (is_null($mbs_other_liabilities)) {
                $mbs_other_liabilities = new MonthlyBalanceSheet();
            ...
            // OWNER'S EQUITY
            $owners_investment = 0;
            $mbs_owner_inv = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', "Owner's Investment")->first();
            if (is_null($mbs_owner_inv)) {
                $mbs_owner_inv = new MonthlyBalanceSheet();
            ...
            $retained_earnings = 0;
            $mbs_retained = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', "Retained Earnings")->first();
            if (is_null($mbs_retained)) {
                $mbs_retained = new MonthlyBalanceSheet();
            ...
            $other_equity = 0;
            $mbs_other_equity = MonthlyBalanceSheet::where('shop_id', $shop->id)->where('date', $bs_date)->where('item_desc', 'Other')->where('item_category', "OWNER'S EQUITY")->first();
            if (is_null($mbs_other_equity)) {
                $mbs_other_equity = new MonthlyBalanceSheet();
            ...
            Log::info('Monthly Balance Sheet already created');
        }
    }
}
