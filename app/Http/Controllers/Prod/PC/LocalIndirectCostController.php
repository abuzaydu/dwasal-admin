...
class LocalIndirectCostController extends Controller
{
    /**
    ...
    {
        $indirectcost = new LocalIndirectCost();
    ...
    public function update(Request $request, string $id)
    {
        ...
        $indirectcost = LocalIndirectCost::find($id);
