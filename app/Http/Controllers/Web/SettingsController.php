...
class SettingsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request['is_dct_settings']) {
            ...
            $setting->is_cm_business = $request['is_cm_business'];
            $setting->dc_no_days = $request['dc_no_days'];
            $setting->dt_no_days = $request['dt_no_days'];
            ...
            $setting->enable_auto_note = $request['enable_auto_note'];
            ...
            $setting->is_health_center = $request['is_health_center'];
            $setting->rvl_days = $request['rvl_days'];
            $setting->exp_rl_days = $request['exp_rl_days'];
            $setting->save();
        }
    ...
    public function invoiceTemplateSetting()
    {
        ...
        $colors = array(
            '#0459c6', '#a99f03', '#04899e', '#389e04', '#e56806', '#7306e6', '#e50606', '#e5ac06', '#049e72', '#9e0480', '#56049e', '#dbaf61'
        );
