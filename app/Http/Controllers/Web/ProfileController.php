...
class ProfileController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if (!is_null($user)) {
            ...
            $message = 'User ' . $user->first_name . ' was successfully deactivated from accessing the system';
            return redirect('users-and-roles')->with('success', $message);
        }else{
    ...
    public function activateUser($id)
    {
        ...
        if ($user) {
            ...
            $message = 'User ' . $user->first_name . ' was successfully activated to access the system';
            return redirect('users-and-roles')->with('success', $message);            
        }else{
            return redirect('users-and-roles')->with('info', 'User not Found');
        }
    ...
    public function removeUser($id)
    {
        ...
        if ($user) {
            ...
            $message = 'User ' . $user->first_name . ' was successfully Removed';
            return redirect('users-and-roles')->with('success', $message);            
        }else{
            return redirect('users-and-roles')->with('info', 'User not Found');
        }
