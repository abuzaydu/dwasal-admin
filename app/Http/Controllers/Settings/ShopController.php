...
class ShopController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('account.create', compact('page', 'btypes', 'stype'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!is_null($company)) {
            ...
            $shop->name = $request['shop_name'];
            $shop->business_type_id = $request['business_type_id'];
            $shop->subscription_type_id = $stype->id;
            $shop->is_warehouse = $request['is_warehouse'];
            if ($shop->is_warehouse) {
                $shop->parent_shop_id = $request['parent_shop_id'];
            }
            ...
            $supplier->supplier_for = 'Stock';
            $supplier->time_created = \Carbon\Carbon::now();
            $supplier->save();
            ...
            if (!$shop->is_warehouse && $request['create_warehouse'] == 1) {
                ...
                $shopwh->subscription_type_id = $stype->id;
    ...
    public function show($id)
    {
        ...
        return view('account.show', compact('page', 'title', 'title_sw', 'shop', 'btype', 'btypes'));
    }
