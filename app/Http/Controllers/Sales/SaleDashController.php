        ...
        if (!is_null($company)) {
            ...
            if (!is_null($payment)) {
                ...
                if (!is_null($currstore)) {
                    ...
                    $services = AnSale::where('an_sales.shop_id', $shop->id)->where('an_sales.is_deleted', false)->join('service_sale_items', 'service_sale_items.an_sale_id', '=', 'an_sales.id')->whereBetween('service_sale_items.time_created', [$start, $end])->join('services', 'service_sale_items.service_id', '=', 'services.id')->groupBy('name')->orderBy('total', 'desc')->take(10)->get([
                ...
                return view('sales.index', compact('page', 'title', 'title_sw', 'shop', 'total_sales', 'total_collections', 'total_expenses', 'total_debts', 'no_customers', 'products', 'services', 'is_post_query', 'payment', 'status', 'start_date', 'end_date', 'settings', 'currency', 'currstore', 'shops', 'labels', 'salesdata', 'gelabels', 'grosses', 'expensesdata', 'gross_profit'));
            } else {
